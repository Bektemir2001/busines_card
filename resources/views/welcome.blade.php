...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><img src="{{asset('assets/img/viplogo.png')}}" alt="..." /></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        <li class="nav-item"><a class="nav-link" href="#services">О нас</a></li>
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Безконтактные визитки</div>
                <div class="masthead-heading text-uppercase">Одна карта - вместо тысячи визиток</div>
                <a class="btn btn-primary btn-xl text-uppercase" href="#services">Подробнее</a>
            </div>
        </header>
        <!-- Services-->
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4 mb-sm-0">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal5">
                                ...
                                <img class="img-fluid" src="{{asset('public/assets/img/portfolio/5.jpg')}}" alt="..." />
                            </a>
                            <div class="portfolio-caption">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 my-3 my-lg-0">
                        <a class="btn btn-dark btn-social mx-2" href="https://www.instagram.com/vipcard.kg/"><i class="fab fa-twitter"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="https://www.instagram.com/vipcard.kg/"><i class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="https://www.instagram.com/vipcard.kg/"><i class="fab fa-instagram"></i></a>
                    </div>
